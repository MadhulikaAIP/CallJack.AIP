      ...
      <div className="blackBg">
        <div className="container">
          <InnerWrapper className="flexSpaceCenter" style={{ padding: "30px 0" }}>
            ...
            <StyleP className="whiteColor font13" style={{ fontSize: "18px", fontWeight: "bold" }}>
...
const InnerWrapper = styled.div`
  display: flex;
  justify-content: space-between; /* Instead of flexSpaceCenter for better responsiveness */
  align-items: center;
