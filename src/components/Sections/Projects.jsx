...
// Assets
import ProjectImg1 from "../../assets/img/team/Madhulika.jpeg";
import ProjectImg2 from "../../assets/img/team/Sashank.jpeg";
import ProjectImg3 from "../../assets/img/team/Mehak.jpeg";
        ...
        <div className="container">
          ...
          <div className="row textCenter">
            ...
            <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <ProjectBox
                img={ProjectImg2}
                title="Sashank Attaluri"
                text="Solutioning & Design"
                action={() => alert("clicked")}
              />
            </div>
            <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div className="container">
          <Advertising className="flexSpaceCenter">
            ...
            <AddRight>
              ...
              Post your job and connect with skilled contractors for your repair and maintenance needs.
              </p>
